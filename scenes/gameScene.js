...
import styles, { WIDTH, HEIGHT, TEXT_COLOR, HEADER_STYLE } from '../styles/styles';
    ...
    return (
      <ScrollView minimumZoomScale={MIN_ZOOM} maximumZoomScale={MAX_ZOOM}
        ...
        <View style={styles.headerWithImage}>
          ...
          <Text style={{color: '#000000', textAlign:'center', fontSize: HEIGHT/14, fontWeight: '900'}}>
            Šifrovací hra
          </Text>
          <Image style={{width: WIDTH/6, height: HEIGHT/10, marginTop:10,}} source={require('../images/lupa.png')}/>
        </View>
        <Text style={{fontSize: HEIGHT/32, color: TEXT_COLOR, backgroundColor: 'rgba(0,0,0,0)', paddingLeft : 15, paddingRight : 15,  textAlign: 'justify', marginTop:-20,}}>
          Čeká na vás spousta zábavy, cesta kolem světa, 10&nbsp;stanovišť a jedna lamí píseň.
        </Text>
        <Text style={{fontSize: HEIGHT/32, color: TEXT_COLOR, backgroundColor: 'rgba(0,0,0,0)', paddingTop: 15, paddingLeft : 15, paddingRight : 15, textAlign: 'justify'}}>
        ...
        <Hyperlink onPress={() => {this._openURL('http://www.dotkni-se-evoluce.cz')}}>
          <Text style={[styles.ctext, {fontSize: HEIGHT/32, color: 'green', fontWeight: '800',marginTop:10, marginBottom:10,
            textAlign: 'center', backgroundColor: 'rgba(0,0,0,0)'}]}>
            www.dotkni-se-evoluce.cz
          </Text>
        </Hyperlink>
        <Text style={{fontSize: HEIGHT/32, color: TEXT_COLOR, backgroundColor: 'rgba(0,0,0,0)', paddingLeft : 15, paddingRight : 15}}>
